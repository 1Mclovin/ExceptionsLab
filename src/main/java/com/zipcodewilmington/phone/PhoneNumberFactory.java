...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        ...
        String createNumber = String.format("(%d)-%d-%d",areaCode,centralOfficeCode,phoneLineCode);
       try{
           return createPhoneNumber(createNumber);
       }catch (InvalidPhoneNumberFormatException e){
           e.printStackTrace();
           logger.info("error is coming from trying to create phone number safely");
       }
       return null;
    }
